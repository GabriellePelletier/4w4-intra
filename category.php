<!-- Page Category - affiche les produits selon la catégorie -->
...
<?php get_header(); ?>
    ...
    <div id="accueil" class="global">
      <section>
      <h2><b>Voici le résultat de votre recherche :</b></h2>
        ...
        <?php
         ...
         foreach ($categories as $category) {
           ?>
           <div class="carte">
             <h2 class="title"><a href="<?php echo get_permalink(); ?>"><?php echo $category->name; ?></a></h2>
